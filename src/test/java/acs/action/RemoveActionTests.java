...
class RemoveActionTests {
	...
	void testRemoveWaterbowlFromNonEmptyDBRemovesSameWaterbowlAndReturnsStatus2xx() {
		...
		removeWaterBowlFromFeedingArea(waterBowlChildOfFeedingArea, playerBoundary);
	...
	void testRemoveFoodbowlFromNonEmptyDBRemovesSameFoodbowlAndReturnsStatus2xx() {
		...
		// Removes existing WaterBowl
		removeFoodBowlFromFeedingArea(foodBowlChildOfFeedingArea, playerBoundary);
	...
	private void removeWaterBowlFromFeedingArea(ElementBoundary waterBowl, UserBoundary playerBoundary) {
		ActionBoundary removeWaterBowlFromMapAction = new ActionBoundary(null, "remove-water_bowl",
				new Element(waterBowl.getElementId()), null, new InvokedBy(playerBoundary.getUserId()),
				waterBowlActionAttributes());
	...
	private void removeFoodBowlFromFeedingArea(ElementBoundary foodBowl, UserBoundary playerBoundary) {
		ActionBoundary addFoodBowlToFeedingAreaAction = new ActionBoundary(null, "remove-food_bowl",
				new Element(foodBowl.getElementId()), null, new InvokedBy(playerBoundary.getUserId()),
				foodBowlActionAttributes());
		postAnAction(addFoodBowlToFeedingAreaAction);
	}
	...
	private Map<String, Object> foodBowlActionAttributes() {
		...
		actionAttributes.put("lastFillDate", "2020-06-06");
		return actionAttributes;
	}
