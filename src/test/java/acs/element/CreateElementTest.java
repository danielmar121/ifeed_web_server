...
public class CreateElementTest {
	...
	@Test
	public void testCreateElementByPlayerOrAdminWillThrowException() throws Exception
	{
		// When user Posts element
		// Given they are Player or Admin
		// Throw Exception
		UserBoundary playerBoundary = UserTestUtil.playerPost(this.restTemplate, this.url);	
		UserBoundary adminBoundary = UserTestUtil.adminPost(this.restTemplate, this.url);	
		
		assertThrows(RuntimeException.class, () -> ElementTestUtil.elementPost(this.restTemplate, this.url, playerBoundary));
		assertThrows(RuntimeException.class, () -> ElementTestUtil.elementPost(this.restTemplate, this.url, adminBoundary));
	}
