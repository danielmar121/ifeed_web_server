...
public class ElementTestUtil {
	...
	public static String[] elementTypes = new String[] { "food_bowl", "water_bowl", "feeding_area", "map" };
	public static String[] animals = new String[] { "dog", "cat", "mouse", "parrot", "bat" };
	public static String[] foodBrands = new String[] { "bonzo", "drools", "tripett", "petkind" };
	public static String[] waterQualities = new String[] { "amazing", "nice", "bad", "worst" };
	...
	public static ElementBoundary randElementBoundary() {
		...
		String randType = elementTypes[rand.nextInt(elementTypes.length)];
	...
	public static ElementBoundary[] playerGetParentOf(RestTemplate restTemplate, String url, ElementBoundary elementChild, UserBoundary player) {
		return restTemplate.getForObject(url + "/elements/{userDomain}/{userEmail}/{elementDomain}/{elementId}/parents",
				ElementBoundary[].class, player.getUserId().getDomain(),
				player.getUserId().getEmail(), elementChild.getElementId().getDomain(),
				elementChild.getElementId().getId());
	}
